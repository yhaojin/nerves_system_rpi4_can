defmodule NervesSystemRpi4Can.MixProject do
  use Mix.Project

  @github_organization "yhaojin"
  @app :nerves_system_rpi4_can
  ...
  defp nerves_package do
    [
      ...
      build_runner: Nerves.Artifact.BuildRunners.Docker,  # Added this line
  ...
  defp description do
    "Nerves System - Raspberry Pi 4 (64-bits) with CAN Support"
  end
